...
import SelectedVariantAddToCartButton from './buttons/SelectedVariantAddToCart';
import SelectedVariantBuyNowButton from './buttons/SelectedVariantBuyNow';
import MoneyCompareAtPrice from './money/CompareAtPrice';
import MoneyPrice from './money/Price';
...
export default function ProductTooltip({
  ...
  const {handle, options, id, title, vendor} = storefrontProduct;
    ...
    <div className="border-1 relative w-[14rem] rounded border border-gray bg-white p-3">
      ...
      <div className="mt-3 text-md">
        <div className="space-y-1">
          {/* Title */}
          <Link className="font-bold hover:underline" to={`/products/${id}`}>
            {title}
          </Link>
