...
import {useFilterUI} from './FilterUIProvider';
...
/**
 * A client component that contains the filter dialog for search/collection pages
 */
export default function FilterDialog({children, filtersLength = 0}: Props) {
