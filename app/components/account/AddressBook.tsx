...
import FormDialog from '~/components/account/FormDialog';
import AddressForm from '~/components/account/forms/Address';
    ...
    <>
      ...
      <div className="grid w-full">
        ...
        <div>
          ...
          <button className="btn-primary" onClick={handleCreateAddress}>
            Add Address
          </button>
        </div>
      </div>
